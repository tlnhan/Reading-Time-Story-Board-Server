    ...
    if (Action === "GET") {
      if (result.recordset.length > 0) {
        const processedData = result.recordset.map((item) => ({
          ...
          Level: item.Level.split(";"),
          Special_Feature: item.Special_Feature.split(";"),
          Recommended_Student: item.Recommended_Student.split(";"),
          Recommended_Level: item.Recommended_Level.split(";"),
          Character: item.Character.split(";"),
          Lesson_Style: item.Lesson_Style.split(";"),
        }));
